...
if __name__ == "__main__":
    project_base_path = '/home/smith/Agon/mystuff/pingo'

    base_filename = 'viking'
    src_rgba8_file = f'{project_base_path}/assets/{base_filename}.bgra'
    src_img_size = (1024, 1024)
    tgt_png_file = f'{project_base_path}/assets/{base_filename}.png'
    pil_img = rgba8_to_img(src_rgba8_file, src_img_size[0], src_img_size[1])
    pil_img.save(tgt_png_file)

    # base_filename = 'Lara'
    # src_png_file = f'{project_base_path}/assets/{base_filename}.png'
    # tgt_png_file = f'{project_base_path}/assets/{base_filename}.png'
    # tgt_rgba8_file = f'{project_base_path}/assets/{base_filename}.rgba8'
    # tgt_rgba2_file = f'{project_base_path}/assets/{base_filename}.rgba2'
